from interfaces.IRequestFactory import IRequestFactory
...
class YFRequestFactory(IRequestFactory):
      ...
      URL_PARAMETERS_FINANCIALS = f"lang=en-GB&region=GB&symbol=[TICKER]&padTimeSeries=true&type=[PARAMETERISED_FIELDS]&merge=false&period1=400000000&period2=1900000000&corsDomain=uk.finance.yahoo.com"
      ...
      ANNUAL_BALANCE_SHEET_BASE_URL = "https://query1.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
      ...
      QUARTERLY_BALANCE_SHEET_BASE_URL = "https://query1.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
      ...
      ANNUAL_CASH_FLOW_BASE_URL = "https://query1.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
      ...
      QUARTERLY_CASH_FLOW_BASE_URL = "https://query2.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
      ...
      ANNUAL_INCOME_STATEMENT_BASE_URL = "https://query2.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
      ...
      QUARTERLY_INCOME_STATEMENT_BASE_URL = "https://query1.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
      ...
      STATISTICS_BASE_URL = "https://query2.finance.yahoo.com/ws/fundamentals-timeseries/v1/finance/timeseries/[TICKER]"
